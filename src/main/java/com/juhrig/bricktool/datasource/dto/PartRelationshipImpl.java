...
public class PartRelationshipImpl implements PartRelationship{
   ...
   // @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "part_relationship_id_seq")
    ...
    public PartRelationshipImpl(){
        id = 0;
    }

    public PartRelationshipImpl(String relationshipType, String childPartNumber, String parentPartNumber){
    ...
    public boolean equals(Object obj) {
        return this.relationshipType.equals(((PartRelationshipImpl)obj).getRelationshipType())
                && this.childPartNumber.equals(((PartRelationshipImpl)obj).getChildPartNumber())
                && this.parentPartNumber.equals(((PartRelationshipImpl)obj).getParentPartNumber());
    }
